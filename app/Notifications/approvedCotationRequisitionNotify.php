...
class approvedCotationRequisitionNotify extends Notification implements ShouldQueue
{
    use Queueable;
...
//		    ->cc(['silva.zanin@gmail.com', 'glauco@tracoconstrucao.com.br'])
		    ->success()
		    ->subject('A cotação da requisição #' . $id . ' foi aprovada')
		    ->greeting('Olá ' .$this->username .'!')
		    ->line('A cotação #' . $id . ' foi aprovada!')
