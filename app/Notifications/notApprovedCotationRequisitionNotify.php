...
class notApprovedCotationRequisitionNotify extends Notification implements ShouldQueue
{
    use Queueable;
...
//			->cc(['silva.zanin@gmail.com', 'glauco@tracoconstrucao.com.br'])
			->error()
			->subject('A cotação da requisição #' . $id . ' não foi aprovada')
			->greeting('Olá ' .$this->username .'!')
			->line('A cotação #' . $id . ' foi negada!')
