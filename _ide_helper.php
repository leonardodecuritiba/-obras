 ...
 * Generated for Laravel 5.5.40 on 2018-04-25 07:10:53.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function success($type, $entity, $route = null, $data = null)
        {
            return \Illuminate\Routing\ResponseFactory::success($type, $entity, $route, $data);
        }
        ...
        {
            return \Illuminate\Routing\ResponseFactory::info($data, $message);
        }
         ...
         * @static 
         */ 
        public static function return($route, $page_response, $data = null)
        {
            return \Illuminate\Routing\ResponseFactory::return($route, $page_response, $data);
        }
         ...
         * @static 
         */ 
        public static function request($errors)
        {
            return \Illuminate\Routing\ResponseFactory::request($errors);
        }
