    ...
    <div class="col-sm-3">
        <div class="form-group form-float">
            <div class="form-line">
                ...
                {{Form::select('state_id', $PageResponse->auxiliar['states'], old('state_id',(isset($DataAddress) ? $DataAddress->state_id : '')), ['placeholder' => 'Escolha o Estado', 'class'=>'form-control select2_single','id' => 'select-state', 'required'])}}
