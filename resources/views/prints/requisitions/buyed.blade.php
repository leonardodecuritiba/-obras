...
//	    $supplier = $datum->first()->buy_supplier;
//	    echo 'supplier '.$supplier->id.'-'.'<br>';
...
//    }
    ...
    ?>
    @foreach($Requisition->requisitionBudgetsFormatted()->groupBy('requisition_buy.supplier_id') as $products)
        <?php $supplier = $products->first()->buy_supplier; ?>
        <table border="1" class="table table-condensed table-bordered">

            @include('prints.inc.supplier')
